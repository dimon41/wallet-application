...
var ICONS = {
  add: async () => (await import("./add-RBITEFR5.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-RZXKRIWA.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-FJJT3AYR.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-XWXJGDMG.js")).appStoreSvg,
  apple: async () => (await import("./apple-HK73MVA4.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-IRA7UJYI.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-3DZUG35P.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-23C5WKHL.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-JXIZLQEZ.js")).arrowTopSvg,
  bank: async () => (await import("./bank-RUSZHPHP.js")).bankSvg,
  browser: async () => (await import("./browser-XJE3BAGI.js")).browserSvg,
  card: async () => (await import("./card-ETH45G3S.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-JQSF4PXY.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-6SPMYQ4W.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-7BLCXA43.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-4CIW3HSR.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-3L3SUTZ3.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-NPXYNSL6.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-X5DRCELM.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-XY5FGZ3I.js")).clockSvg,
  close: async () => (await import("./close-RH5H3AL2.js")).closeSvg,
  compass: async () => (await import("./compass-KNGHPCPF.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-7B3224UW.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-F5INNNAC.js")).copySvg,
  cursor: async () => (await import("./cursor-4VIU7YWA.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-O2CO6Y6L.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-VB7UAQQP.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-GAALP6TQ.js")).disconnectSvg,
  discord: async () => (await import("./discord-PZAKY3VU.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-6A5Y7G4L.js")).etherscanSvg,
  extension: async () => (await import("./extension-U2VSI4CR.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CY7IZHF6.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-R35D5GL4.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-DGSUPE6T.js")).farcasterSvg,
  filters: async () => (await import("./filters-OIO2M4KZ.js")).filtersSvg,
  github: async () => (await import("./github-VJJI5RD3.js")).githubSvg,
  google: async () => (await import("./google-QSAQ5QOC.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-OW2Z3IGR.js")).helpCircleSvg,
  image: async () => (await import("./image-32ROOMZO.js")).imageSvg,
  id: async () => (await import("./id-DESBUKWA.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-ORHLVHSZ.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-KGMHN2HA.js")).lightbulbSvg,
  mail: async () => (await import("./mail-HNIGJ2U3.js")).mailSvg,
  mobile: async () => (await import("./mobile-RN2X7QCZ.js")).mobileSvg,
  more: async () => (await import("./more-R7KF4K5Q.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-SGOF75NA.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-SKIWLFGJ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-RKFDYKAN.js")).offSvg,
  playStore: async () => (await import("./play-store-JQENXVJ4.js")).playStoreSvg,
  plus: async () => (await import("./plus-D4PIDNCY.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-W6MLJ4PV.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-2XUVAMU3.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-JYODQR4Q.js")).refreshSvg,
  search: async () => (await import("./search-62TNECAR.js")).searchSvg,
  send: async () => (await import("./send-AFUSPJ6Q.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-ZLUVIMSX.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-HTRMDFVT.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-VKBP774R.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-FJZ47MGQ.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-JOVPEWJ2.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-6PCOJZ6L.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-CQGOHFY2.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-WU663C4Y.js")).twitchSvg,
  twitter: async () => (await import("./x-6EWTQCFQ.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-IHSWMLFP.js")).twitterIconSvg,
  verify: async () => (await import("./verify-K565I5OG.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-3CVTU46L.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-LV3LI6BZ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-CIUP6YUO.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-CIUP6YUO.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-CIUP6YUO.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-Y2YIZMLG.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-3NKXZ7JW.js")).warningCircleSvg,
  x: async () => (await import("./x-6EWTQCFQ.js")).xSvg,
  info: async () => (await import("./info-G2D2UVQK.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-FR2NM2DR.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-34OHLSDB.js")).reownSvg
};
...
//# sourceMappingURL=chunk-Z7J3OJIQ.js.map
