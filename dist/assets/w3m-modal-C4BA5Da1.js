import{i as pe,p as me,s as he,j as ve,M as g,S as ee,R as l,k as v,l as E,m as f,n as a,A as j,o as te,q as ie,C as m,u as H,v as fe,x as k,E as q,O as T,y as M,z as F,B as $,D,T as ge,F as be,G as ye,I as xe}from"./core-DILbQejD.js";import{c as u,n as d,r as w,o as V,U as Ce}from"./index-1_vP7XmF.js";import"./index-Dn5MwUjT.js";import"./index.es-DmiouLn9.js";import"./events-DQ172AOg.js";import"./index-nibyPLVP.js";const p=me({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ke={state:p,subscribe(r){return ve(p,()=>r(p))},subscribeKey(r,e){return he(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=pe(ke),oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await ee.isSIWXCloseDisabled()){g.shake();return}g.close()}},Se=v`
  :host {
    display: block;
