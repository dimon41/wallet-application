...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-3VIKSPKS.js";
import {
  ens_normalize
} from "./chunk-5PG5FAKG.js";
import "./chunk-VPW5LQ2X.js";
import "./chunk-ANJCMEYS.js";
import "./chunk-5VJP2ENM.js";
import {
  __assign,
  __rest,
  __spreadArray,
...
import {
  ...
  useSignMessage,
  useSwitchChain
} from "./chunk-UMMKY42E.js";
import "./chunk-TTNRIITN.js";
import {
  import_index
} from "./chunk-MMBGGHPB.js";
import {
  http,
  withRetry,
  withTimeout
} from "./chunk-PUAGH27P.js";
import "./chunk-YALVWRLX.js";
import "./chunk-VM4N7N6L.js";
import {
...
import {
  ...
  utf8ToBytes,
  validateObject
} from "./chunk-XWITJT5W.js";
import "./chunk-ZO77EUZE.js";
import {
  useQuery
} from "./chunk-L3X77WPN.js";
import {
  require_jsx_runtime
} from "./chunk-KATDHUVJ.js";
import {
  require_react_dom
} from "./chunk-WQKTZNEQ.js";
import {
  require_react
} from "./chunk-HYVKYW6Q.js";
import {
  __commonJS,
  __toESM
    ...
    (function() {
      ...
      var runInContext = (function runInContext2(context) {
        ...
        function result(object3, path2, defaultValue) {
          ...
          while (++index < length) {
            var value = object3 == null ? undefined2 : object3[toKey(path2[index])];
            if (value === undefined2) {
              index = length;
              value = defaultValue;
            }
...
var require_re = __commonJS({
  "node_modules/@metamask/utils/node_modules/semver/internal/re.js"(exports, module) {
    ...
    createToken("MAINVERSION", `(${src7[t.NUMERICIDENTIFIER]})\\.(${src7[t.NUMERICIDENTIFIER]})\\.(${src7[t.NUMERICIDENTIFIER]})`);
    createToken("MAINVERSIONLOOSE", `(${src7[t.NUMERICIDENTIFIERLOOSE]})\\.(${src7[t.NUMERICIDENTIFIERLOOSE]})\\.(${src7[t.NUMERICIDENTIFIERLOOSE]})`);
    createToken("PRERELEASEIDENTIFIER", `(?:${src7[t.NONNUMERICIDENTIFIER]}|${src7[t.NUMERICIDENTIFIER]})`);
    createToken("PRERELEASEIDENTIFIERLOOSE", `(?:${src7[t.NONNUMERICIDENTIFIER]}|${src7[t.NUMERICIDENTIFIERLOOSE]})`);
    createToken("PRERELEASE", `(?:-(${src7[t.PRERELEASEIDENTIFIER]}(?:\\.${src7[t.PRERELEASEIDENTIFIER]})*))`);
    createToken("PRERELEASELOOSE", `(?:-?(${src7[t.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${src7[t.PRERELEASEIDENTIFIERLOOSE]})*))`);
    createToken("BUILDIDENTIFIER", `${LETTERDASHNUMBER}+`);
    createToken("BUILD", `(?:\\+(${src7[t.BUILDIDENTIFIER]}(?:\\.${src7[t.BUILDIDENTIFIER]})*))`);
    createToken("FULLPLAIN", `v?${src7[t.MAINVERSION]}${src7[t.PRERELEASE]}?${src7[t.BUILD]}?`);
    createToken("FULL", `^${src7[t.FULLPLAIN]}$`);
    createToken("LOOSEPLAIN", `[v=\\s]*${src7[t.MAINVERSIONLOOSE]}${src7[t.PRERELEASELOOSE]}?${src7[t.BUILD]}?`);
    createToken("LOOSE", `^${src7[t.LOOSEPLAIN]}$`);
    createToken("GTLT", "((?:<|>)?=?)");
    createToken("XRANGEIDENTIFIERLOOSE", `${src7[t.NUMERICIDENTIFIERLOOSE]}|x|X|\\*`);
    createToken("XRANGEIDENTIFIER", `${src7[t.NUMERICIDENTIFIER]}|x|X|\\*`);
    createToken("XRANGEPLAIN", `[v=\\s]*(${src7[t.XRANGEIDENTIFIER]})(?:\\.(${src7[t.XRANGEIDENTIFIER]})(?:\\.(${src7[t.XRANGEIDENTIFIER]})(?:${src7[t.PRERELEASE]})?${src7[t.BUILD]}?)?)?`);
    createToken("XRANGEPLAINLOOSE", `[v=\\s]*(${src7[t.XRANGEIDENTIFIERLOOSE]})(?:\\.(${src7[t.XRANGEIDENTIFIERLOOSE]})(?:\\.(${src7[t.XRANGEIDENTIFIERLOOSE]})(?:${src7[t.PRERELEASELOOSE]})?${src7[t.BUILD]}?)?)?`);
    createToken("XRANGE", `^${src7[t.GTLT]}\\s*${src7[t.XRANGEPLAIN]}$`);
    createToken("XRANGELOOSE", `^${src7[t.GTLT]}\\s*${src7[t.XRANGEPLAINLOOSE]}$`);
    createToken("COERCEPLAIN", `${"(^|[^\\d])(\\d{1,"}${MAX_SAFE_COMPONENT_LENGTH}})(?:\\.(\\d{1,${MAX_SAFE_COMPONENT_LENGTH}}))?(?:\\.(\\d{1,${MAX_SAFE_COMPONENT_LENGTH}}))?`);
    createToken("COERCE", `${src7[t.COERCEPLAIN]}(?:$|[^\\d])`);
    createToken("COERCEFULL", src7[t.COERCEPLAIN] + `(?:${src7[t.PRERELEASE]})?(?:${src7[t.BUILD]})?(?:$|[^\\d])`);
    createToken("COERCERTL", src7[t.COERCE], true);
    createToken("COERCERTLFULL", src7[t.COERCEFULL], true);
    createToken("LONETILDE", "(?:~>?)");
    createToken("TILDETRIM", `(\\s*)${src7[t.LONETILDE]}\\s+`, true);
    exports.tildeTrimReplace = "$1~";
    createToken("TILDE", `^${src7[t.LONETILDE]}${src7[t.XRANGEPLAIN]}$`);
    createToken("TILDELOOSE", `^${src7[t.LONETILDE]}${src7[t.XRANGEPLAINLOOSE]}$`);
    createToken("LONECARET", "(?:\\^)");
    createToken("CARETTRIM", `(\\s*)${src7[t.LONECARET]}\\s+`, true);
    exports.caretTrimReplace = "$1^";
    createToken("CARET", `^${src7[t.LONECARET]}${src7[t.XRANGEPLAIN]}$`);
    createToken("CARETLOOSE", `^${src7[t.LONECARET]}${src7[t.XRANGEPLAINLOOSE]}$`);
    createToken("COMPARATORLOOSE", `^${src7[t.GTLT]}\\s*(${src7[t.LOOSEPLAIN]})$|^$`);
    createToken("COMPARATOR", `^${src7[t.GTLT]}\\s*(${src7[t.FULLPLAIN]})$|^$`);
    createToken("COMPARATORTRIM", `(\\s*)${src7[t.GTLT]}\\s*(${src7[t.LOOSEPLAIN]}|${src7[t.XRANGEPLAIN]})`, true);
    exports.comparatorTrimReplace = "$1$2$3";
    createToken("HYPHENRANGE", `^\\s*(${src7[t.XRANGEPLAIN]})\\s+-\\s+(${src7[t.XRANGEPLAIN]})\\s*$`);
    createToken("HYPHENRANGELOOSE", `^\\s*(${src7[t.XRANGEPLAINLOOSE]})\\s+-\\s+(${src7[t.XRANGEPLAINLOOSE]})\\s*$`);
    createToken("STAR", "(<|>)?=?\\s*\\*");
...
var require_range = __commonJS({
  "node_modules/@metamask/utils/node_modules/semver/classes/range.js"(exports, module) {
    ...
    var hyphenReplace = (incPr) => ($0, from8, fM, fm, fp, fpr, fb, to, tM, tm, tp, tpr) => {
      if (isX(fM)) {
        from8 = "";
      } else if (isX(fm)) {
        from8 = `>=${fM}.0.0${incPr ? "-0" : ""}`;
      } else if (isX(fp)) {
        from8 = `>=${fM}.${fm}.0${incPr ? "-0" : ""}`;
      } else if (fpr) {
        from8 = `>=${from8}`;
      } else {
        from8 = `>=${from8}${incPr ? "-0" : ""}`;
...
var NumberTooLargeError = class extends BaseError {
  constructor({ number: number2 }) {
    super(`Number exceeds maximum safe integer (${Number.MAX_SAFE_INTEGER}): ${number2}`);
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
      writable: true,
...
function calcElligatorRistrettoMap(r0) {
  ...
  const Ns = mod3((r2 + _1n3) * ONE_MINUS_D_SQ);
  let c = BigInt(-1);
  ...
  if (!Ns_D_is_sq)
    c = r2;
  const Nt = mod3(c * (r2 - _1n3) * D_MINUS_ONE_SQ - D);
  const s2 = s * s;
  const W0 = mod3((s + s) * D);
...
var Bitmap = class _Bitmap {
  ...
  maskWord(wi, mask2, v) {
    ...
    defined[wi] |= mask2;
    value[wi] = value[wi] & ~mask2 | -v & mask2;
  }
  set(x, y, v) {
    if (v === void 0)
      return;
  ...
  fillRectConst(x0, y0, w, h, v) {
    ...
    for (let ry = 0; ry < h; ry++) {
      ...
      if (startWord === endWord) {
        const mask2 = rangeMask(startBit, endBit - startBit + 1);
        this.maskWord(rowBase + startWord, mask2, v);
        continue;
      }
  ...
  rect(c, size4, fn) {
    ...
    this.rectWords(x, y, width, height, (wi, bitX, xPos, yPos, n) => {
      ...
      for (let b = 0; b < n; b++) {
        const mask2 = bitMask(bitX + b);
        const res = fn({ x: xPos + b, y: yPos }, (valWord & mask2) !== 0);
        if (res === void 0)
          continue;
        defWord |= mask2;
        valWord = valWord & ~mask2 | -res & mask2;
      }
      defined[wi] |= defWord;
      value[wi] = valWord;
    });
  ...
  rectRead(c, size4, fn) {
    ...
    this.rectWords(x, y, width, height, (wi, bitX, xPos, yPos, n) => {
      ...
      for (let b = 0; b < n; b++) {
        const mask2 = bitMask(bitX + b);
        fn({ x: xPos + b, y: yPos }, (valWord & mask2) !== 0);
      }
    });
    return this;
  }
...
function drawTemplate(ver, ecc, maskIdx, test = false) {
  ...
  b = b.hLine({ x: 0, y: 6 }, Infinity, ({ x }) => b.isDefined(x, 6) ? void 0 : x % 2 == 0).vLine({ x: 6, y: 0 }, Infinity, ({ y }) => b.isDefined(6, y) ? void 0 : y % 2 == 0);
  {
    ...
    for (let i = 8; i < 15; i++)
      b.set(8, size4 - 15 + i, getBit(i));
    for (let i = 0; i < 8; i++)
      b.set(size4 - i - 1, 8, getBit(i));
    for (let i = 8; i < 9; i++)
      b.set(15 - i - 1 + 1, 8, getBit(i));
    for (let i = 9; i < 15; i++)
      b.set(15 - i - 1, 8, getBit(i));
    b.set(8, size4 - 8, !test);
  }
  if (ver >= 7) {
...
function encode2(ver, ecc, data, type2, encoder = utf8ToBytes3) {
  let encoded = "";
...
function drawQR(ver, ecc, data, maskIdx, test = false) {
  ...
  zigzag(b, maskIdx, (x, y, mask2) => {
    ...
    b.set(x, y, value !== mask2);
  });
  if (i !== need)
    throw new Error("QR: bytes left after draw");
  return b;
}
var mkPattern = (pattern2) => {
  const s = pattern2.map((i) => i ? "1" : "0").join("");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-OJZSKCGT.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-ZDBRLHVR.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-3GNKTHYI.js");
...
function assert3(value, struct, message) {
  const result = validate3(value, struct, { message });
  if (result[0]) {
    throw result[0];
  }
}
function create4(value, struct, message) {
  const result = validate3(value, struct, { coerce: true, message });
  if (result[0]) {
    throw result[0];
  } else {
    return result[1];
...
function mask(value, struct, message) {
  const result = validate3(value, struct, { coerce: true, mask: true, message });
  if (result[0]) {
    throw result[0];
  } else {
    return result[1];
...
function is(value, struct) {
  const result = validate3(value, struct);
  return !result[0];
}
function validate3(value, struct, options = {}) {
...
function assert4(value, message = "Assertion failed.", ErrorWrapper = AssertionError) {
  if (!value) {
...
var base64 = (struct, options = {}) => {
  ...
  if (characterSet === "base64") {
    ...
    assert4(characterSet === "base64url");
...
function assertIsHexString(value) {
  assert4(isHexString(value), "Value must be a hexadecimal string.");
}
function getChecksumAddressUnmemoized(hexAddress) {
  assert4(isHexChecksumAddress(hexAddress), "Invalid hex address.");
...
function assertIsBytes(value) {
  assert4(isBytes2(value), "Value must be a Uint8Array.");
}
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-AZKAYZ77.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-WEH5I4CI.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-VACPZBVD.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-ONXAHUBA.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-44JUQ6EW-QDF7HTFL.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-PYAO5YD6-KTCEKRBN.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-Y4ZOVFV4-AR6HKM66.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-HRGOJ6VT-WEA7Q55U.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-IGGVC6RM-3TDQSJRP.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-XSKAA3MF-HRRPRV7T.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-KUOB4UAL-UKAN6H2E.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-4WRQ63RX-FNZQH7BN.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-I2K7AIEP-Z5O4BIEM.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-6VZW6Q3Z-DPLZ7HUL.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-N3XOZ4SV-IGRSCA2O.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-IITAPRET-3USQ3T3N.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-3ZQCKCQE-3GHC5S7N.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-QUPUGMUF-K6EWVXNH.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-SSN6SV5E-YJ2V3TLY.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-7BUVRNYY-XLZ5PGEH.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-HJBN674C-ELFVUYBQ.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-JW3WLRKE-AJBD2E7C.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-VNNRNXY7-K4PNGTZB.js")).default;
    default:
      return (await import("./en_US-Y4ZOVFV4-AR6HKM66.js")).default;
  }
};
...
var apeChainIcon = {
  ...
  iconUrl: async () => (await import("./apechain-SX5YFU6N-LNBWKUJY.js")).default
};
var arbitrumIcon = {
  iconBackground: "#96bedc",
  iconUrl: async () => (await import("./arbitrum-WURIBY6W-TSXVPBUS.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-KOMJD3XY-IPQYVIN7.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-OAXLRA4F-QRV4JW44.js")).default
};
var berachainIcon = {
  iconBackground: "#814625",
  iconUrl: async () => (await import("./berachain-NJECWIVC-A7YDSGUK.js")).default
};
var blastIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./blast-V555OVXZ-CBVD26X6.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-N647EYR2-FNN3KDCJ.js")).default
};
var celoIcon = {
  iconBackground: "#FCFF52",
  iconUrl: async () => (await import("./celo-GEP4TUHG-QPENRWRV.js")).default
};
var cronosIcon = {
  iconBackground: "#002D74",
  iconUrl: async () => (await import("./cronos-HJPAQTAE-DVEGBQWC.js")).default
};
var degenIcon = {
  iconBackground: "#A36EFD",
  iconUrl: async () => (await import("./degen-FQQ4XGHB-ATLPOWX6.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-RGGVA4PY-ILIYWLZR.js")).default
};
var flowIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./flow-5FQJFCTK-5ZN6EGA7.js")).default
};
var gnosisIcon = {
  iconBackground: "#04795c",
  iconUrl: async () => (await import("./gnosis-37ZC4RBL-HVA3SZI4.js")).default
};
var gravityIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./gravity-J5YQHTYH-YJH6TSBK.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-TX56IT5N-4KCZR5GJ.js")).default
};
var hyperevmIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./hyperevm-VKPAA4SA-UYNGHI2U.js")).default
};
var inkIcon = {
  iconBackground: "#7132F5",
  iconUrl: async () => (await import("./ink-FZMYZWHG-ZEQXZRO3.js")).default
};
var kaiaIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./kaia-65D2U3PU-WQI6YIJV.js")).default
};
var lineaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./linea-QRMVQ5DY-ZXJ5FETI.js")).default
};
var mantaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./manta-SI27YFEJ-DUMV5EDU.js")).default
};
var mantleIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./mantle-CKIUT334-NEKV6ILX.js")).default
};
var monadTestnetIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./monad-4KWC6TSS-KCEUVNPR.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-HAF2GUT7-ZP2UL44W.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-WW6ZI7PM-R57NO33P.js")).default
};
var roninIcon = {
  iconBackground: "#1273EA",
  iconUrl: async () => (await import("./ronin-EMCPYXZT-KMSR4KD2.js")).default
};
var sankoIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./sanko-RHQYXGM5-FFV2JRGD.js")).default
};
var superpositionIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./superposition-HG6MMR2Y-NJB4LB54.js")).default
};
var scrollIcon = {
  iconBackground: "#FFEEDA",
  iconUrl: async () => (await import("./scroll-5OBGQVOV-H2VW6EVE.js")).default
};
var unichainIcon = {
  iconBackground: "#F50DB4",
  iconUrl: async () => (await import("./unichain-C5BWO2ZY-R2F5NTUD.js")).default
};
var xdcIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./xdc-KJ3TDBYO-HTWZ2U2R.js")).default
};
var zetachainIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zetachain-TLDS5IPW-7IY6OCFH.js")).default
};
var zkSyncIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./zksync-DH7HK5U4-W6RQFMWY.js")).default
};
var zoraIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zora-FYL5H3IO-W7FRK3YM.js")).default
};
...
var src = async () => (await import("./assets-Q6ZU7ZJ5-UQNH23YO.js")).default;
...
var src2 = async () => (await import("./login-UP3DZBGS-IKUAM57P.js")).default;
...
var signInIcon = async () => (await import("./sign-A7IJEUT5-R5HNDIJ2.js")).default;
function SignIn({
  onClose,
  onCloseModal
}) {
...
var src3 = async () => (await import("./connect-UA7M4XW6-USAIKLZW.js")).default;
...
var src4 = async () => (await import("./create-FASO7PVG-A3MDVJ4C.js")).default;
...
var src5 = async () => (await import("./refresh-S4T5V5GX-APCOOHOK.js")).default;
...
var src6 = async () => (await import("./scan-4UYSQ56Q-QGXTL554.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc":
      return (await import("./Arc-VDBY7LNS-3AJTNYH6.js")).default;
    case "Brave":
      return (await import("./Brave-BRAKJXDS-QC6Q7TPT.js")).default;
    case "Chrome":
      return (await import("./Chrome-65Q5P54Y-2CP5IMUB.js")).default;
    case "Edge":
      return (await import("./Edge-XSPUTORV-LSHPW3MQ.js")).default;
    case "Firefox":
      return (await import("./Firefox-AAHGJQIP-K6OTLQJC.js")).default;
    case "Opera":
      return (await import("./Opera-KQZLSACL-VLUKIA3Q.js")).default;
    case "Safari":
      return (await import("./Safari-ZPL37GXR-R5LQGVCQ.js")).default;
    default:
      return (await import("./Browser-76IHF3Y2-NT7KFHB2.js")).default;
  }
};
...
var getPlatformSrc = async () => {
  ...
  switch (platform) {
    case "Windows":
      return (await import("./Windows-PPTHQER6-OPLFZWYX.js")).default;
    case "macOS":
      return (await import("./Macos-MW4AE7LN-R67WEFOK.js")).default;
    case "Linux":
      return (await import("./Linux-OO4TNCLJ-FZKWMHVY.js")).default;
    default:
      return (await import("./Linux-OO4TNCLJ-FZKWMHVY.js")).default;
  }
};
...
var connectorsForWallets = (walletList, {
  ...
  for (const [groupIndex, { groupName, wallets }] of walletList.entries()) {
    for (const createWallet of wallets) {
      ...
      if (wallet?.iconAccent && !isHexString2(wallet?.iconAccent)) {
        throw new Error(
...
var baseAccount2 = ({
  ...
  return {
    ...
    rdns: "app.base.account",
    iconUrl: async () => (await import("./baseAccount-44UITRK7-ZH7PFTIO.js")).default,
    iconAccent: "#0000FF",
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-SITXT2FV-L55VQC4H.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-O26YNBMX-SMHO3JEY.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-5MNKTR5Z-BS6DFG3C.js")).default,
  installed: (
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-YHWKVTDY-3SZBOT3T.js")).default,
